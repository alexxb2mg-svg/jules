...
ESPACE = "notions"
ORIGINES = ("eleve", "auto")
# Pendant l'epreuve sans aide et les exercices sans IA, Jules ne recoit ni fiche ni attendus (ce serait
# une aide), et la conversation n'appelle jamais le modele : la detection automatique serait perdue.
MODES_SANS_NOTION = ("epreuve", "exercice")
